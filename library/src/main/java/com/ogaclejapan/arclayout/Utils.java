...
class Utils {
    ...
    /**
     * Given the radius and chord fo a circle, find the radian of the sector.
     *
     * @param r radius of the circle
     * @param c chord of the circle
     * @return radian
     */
    static float computeRadian(float r, float c) {
        return (float) (2 * Math.asin(c / (2 * r)));
    }

    static float computeDegreeRadian(float r) {
